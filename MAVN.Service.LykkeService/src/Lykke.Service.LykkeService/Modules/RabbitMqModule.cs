...
#if rabbitpub
using MAVN.Service.LykkeService.Contract;
#endif
#if rabbitsub
using MAVN.Service.LykkeService.DomainServices.RabbitSubscribers;
#endif
using MAVN.Service.LykkeService.Settings;

namespace MAVN.Service.LykkeService.Modules
{
    [UsedImplicitly]
